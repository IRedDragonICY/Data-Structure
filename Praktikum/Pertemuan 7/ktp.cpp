...
public:
    void writeToFile(Node* newNode, const string& mode) {
        ofstream file;
        file.open("data.txt", mode == "front" || mode == "" ? ios::trunc : ios::app);
    ...
    void enqueueFront(Data newData) {
        ...
        writeToFile(newNode, "front");
        count++;
    }
    void enqueueRear(Data newData) {
        Node* head = nullptr;
        Node* tail = nullptr;
    ...
    void input() {
        ...
        cout<<"Pilih cara input data: "<<endl;
        ...
        switch(choice){
            case 1:
                enqueueFront(newNode->data);
                break;
            case 2:
                enqueueRear(newNode->data);
                break;
            default:
